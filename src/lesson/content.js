...
export const CONTENT = {
  ua: {
    ...
    'st.escapement.hint': 'Змініть хід — обидва числа поруч зміняться разом: їхнє відношення від ходу не залежить. Турбійон таймінгу не змінює, він лише усереднює похибку.',
    'st.escapement.f1': 'θ_кліть = β · Z_p/Z_f = β',
    'st.escapement.n1': 'бо Z_f = Z_p = 10 — кліть і спуск ідуть як одне',
    'st.escapement.f2': '1 удар = π/15 рад = %1°',
    'st.escapement.s1': 'оберт кліті',
    'st.escapement.s2': 'секундне колесо',
    'st.escapement.simp': 'колонка нерухомого колеса й вісь кліті співвісні — у калібрі вісь була б порожнистою',
  ...
  en: {
    ...
    'st.escapement.hint': 'Change the rate and both figures move together: their ratio does not depend on it. The tourbillon does not change the timing — it only averages the error.',
    'st.escapement.f1': 'θ_cage = β · Z_p/Z_f = β',
    'st.escapement.n1': 'since Z_f = Z_p = 10 — cage and escapement move as one',
    'st.escapement.f2': '1 beat = π/15 rad = %1°',
    'st.escapement.s1': 'cage turn',
    'st.escapement.s2': 'seconds wheel',
    'st.escapement.simp': 'the fixed wheel post and the cage arbor are coaxial — a real calibre would use a hollow arbor',
