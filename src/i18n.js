...
const DICT = {
  ua: {
    ...
    'part.innerCage': 'Внутрішня кліть',
    ...
    'variants.metric.innerTurn': 'оберт внутрішньої кліті',
    ...
    'variants.doubleAxis.desc': 'Кліть у кліті: внутрішня обертається навколо осі під прямим кутом до зовнішньої — і вдвічі швидше. Привід іде через конічну пару, бо вісь повернуто. «Оберт анкерного колеса» тут прочерк: відносно платини його рух — складання двох обертань навколо різних осей, і одного числа для нього не існує.',
    'gui.camera': 'Камера',
    ...
    'show.nudge': 'Штовхнути важіль',
    'show.safety': 'Запобіжник',
  ...
  en: {
    ...
    'variants.metric.innerTurn': 'inner cage turn',
    ...
    'variants.doubleAxis.desc': 'A cage within a cage: the inner one turns about an axis at a right angle to the outer, and twice as fast. The drive reaches it through a bevel pair, because the axis is turned. «Escape wheel turn» is a dash here: against the plate its motion is two rotations about different axes composed, and no single number stands for that.',
    'gui.camera': 'Camera',
    ...
    'show.step': 'Step',
    'show.home': 'Home view',
    'show.nudge': 'Nudge the lever',
    'show.safety': 'The safety',
