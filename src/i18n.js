...
const DICT = {
  ua: {
    ...
    'variants.lever.desc': 'Анкерне колесо на своїй осі, вилка й баланс поруч на платині.',
    'variants.tourbillon.desc': 'Увесь спуск усередині кліті, яка сама обертається навколо нерухомого колеса.',
  ...
  en: {
    ...
    'variants.lever.desc': 'Escape wheel on its own arbor; fork and balance beside it on the plate.',
    'variants.tourbillon.desc': 'The whole escapement inside a cage that itself turns around a fixed wheel.',
